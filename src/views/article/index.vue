<template>
  <div class="article-container">
    <el-card class="filter-card">
      ...
      :model="form" label-width="40px">
        <el-form-item label="状态">
          <el-radio-group v-model="status">
            <!--
              el-radio 默认把 label 作为文本和选中之后的value值
             -->
            ...
            <el-radio :v-text="4">已删除</el-radio>
          </el-radio-group>
        </el-form-item>
        ...
        <el-form-item>
          <!--
            button 按钮的click事件有个默认参数，当你没有指定这个参数时，它会默认传递一个没有用的数据
           -->
